...
public class Room9 extends JPanel implements Room {
    ...
    public Room9(WallBegin w, GamePanel game, JFrame f, InventoryPanel i) {
        ...
        trash = new ClickedObject("/trash4.png", new MousePoint(880, 660), new MousePoint(1010, 800));
    ...
    class MyMouseListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (hamer.ifChose(e) && ifHamerPicked) {
            ...
            if (coin.ifChose(e) && ifCoinPicked) {
            ...
            if (ifFirstWall) {
                ...
                if (door.ifClicked(e) && !ifCloseFrame && !ifDoorOpen && !ifDrawer2Close && !ifDrawerClose && !ifComputerClose && !ifDeskClose) {
                    if (!ifCodeCorrect) {
                ...
                if (picture.ifClicked(e) && !ifCloseFrame && !ifDoorOpen && !ifDrawer2Close && !ifDrawerClose && !ifComputerClose && !ifDeskClose) {
                ...
                if (!ifCloseFrame) {
                    ...
                    if (codeDoor.ifClicked(e) && !ifComputerClose && !ifDrawer2Close && !ifDrawerClose
                            && !ifDeskClose && !ifDoorClose) {
                        ifCodeDoor = true;
                    }
                    // code of door
                    if (ifCodeDoor) {
                    ...
                    // computer
                    if (computer.ifClicked(e) && !ifDrawerClose && !ifCloseFrame && !ifDrawer2Close && !ifCodeDoor && !ifDoorClose) {
