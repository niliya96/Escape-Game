...
public class Room8 extends JPanel implements Room {
    ...
    boolean ifBatteriesChoose = true;
    ...
    public Room8(WallBegin w, GamePanel game, JFrame f, InventoryPanel i) {
        ...
        buttonA = new ClickedObject("/green.png", new MousePoint(500, 530), new MousePoint(640, 670));
        buttonB = new ClickedObject("/green.png", new MousePoint(730, 530), new MousePoint(870, 670));
        buttonC = new ClickedObject("/green.png", new MousePoint(960, 530), new MousePoint(1100, 670));
        button1 = new ClickedObject("/a.png", new MousePoint(400, 530), new MousePoint(540, 670));
        button2 = new ClickedObject("/a.png", new MousePoint(620, 530), new MousePoint(760, 670));
        button3 = new ClickedObject("/a.png", new MousePoint(850, 530), new MousePoint(990, 670));
        button4 = new ClickedObject("/a.png", new MousePoint(1060, 530), new MousePoint(1205, 670));
    ...
    class MyMouseListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (screwdriver.ifChose(e) && ifScrewdriverPicked) {
            ...
            if (lantern.ifChose(e) && ifLanternPicked) {
            ...
            if (remote.ifChose(e) && ifRemotePicked) {
            ...
            if (batteries.ifChose(e) && ifBatteriesPicked) {
            ...
            if (!ifCloseFrame) {
                ...
                if (ifDrawer2Close) {
                    if (button1.ifClicked(e) && !ifCode2) {
                        ...
                        if (a1.compareTo("p") == 0) {
                            button1.setImg("/p.png");
                        }
                        if (a1.compareTo("r") == 0) {
                            button1.setImg("/r.png");
                        }
                        if (a1.compareTo("s") == 0) {
                    ...
                    if (button2.ifClicked(e) && !ifCode2) {
                        ...
                        if (a2.compareTo("p") == 0) {
                            button2.setImg("/p.png");
                        }
                        if (a2.compareTo("r") == 0) {
                            button2.setImg("/r.png");
                        }
                        if (a2.compareTo("s") == 0) {
                    ...
                    if (button3.ifClicked(e) && !ifCode2) {
                        ...
                        if (a3.compareTo("p") == 0) {
                            button3.setImg("/p.png");
                        }
                        if (a3.compareTo("r") == 0) {
                            button3.setImg("/r.png");
                        }
                        if (a3.compareTo("s") == 0) {
                    ...
                    if (button4.ifClicked(e) && !ifCode2) {
                        ...
                        if (a4.compareTo("p") == 0) {
                            button4.setImg("/p.png");
                        }
                        if (a4.compareTo("r") == 0) {
                            button4.setImg("/r.png");
                        }
                        if (a4.compareTo("s") == 0) {
                ...
                if (ifDrawer1Close) {
                    if (buttonA.ifClicked(e) && !ifCode1) {
                        ...
                        if (b1.compareTo("green") == 0) {
                            buttonA.setImg("/green.png");
                        }
                    ...
                    if (buttonC.ifClicked(e) && !ifCode1) {
                        ...
                        if (b3.compareTo("purple") == 0) {
                            buttonC.setImg("/purple.png");
                        }
                    }
                    ...
                    if (!ifLanternPicked && ifCode1) {
                        if (lantern.ifChose(e)) {
                            ...
                            lantern.setEnd(new MousePoint(130, 105));
                            message.setText("I picked a lantern.");
