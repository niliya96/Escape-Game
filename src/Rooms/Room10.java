...
public class Room10 extends JPanel implements Room {
    ...
    boolean ifBinocularsChoose = true;
    ...
    class MyMouseListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (napkin.ifChose(e) && ifNapkinPicked) {
            ...
            if (finalKey.ifChose(e) && ifFinalKeyPicked) {
            ...
            if (binoculars.ifChose(e) && ifBinocularsPicked) {
            ...
            if (ifFirstWall) {
                ...
                if (!ifCloseFrame) {
                    ...
                    // outside
                    if (e.getX() >= 125 && e.getX() <= 380 && e.getY() >= 265 && e.getY() <= 510) {
                        ifCloseFrame = true;
                        Outside = true;
                    }
                    // close laibrary
                    ...
                    // close sofa
                    if (e.getX() >= 510 && e.getX() <= 625 && e.getY() >= 585 && e.getY() <= 680) {
                        ifCloseFrame = true;
                        ifSofaClose = true;
                    }
                    // close code laibrary
