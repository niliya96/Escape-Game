...
public class Room6 extends JPanel implements Room {
    ...
    class MyMouseListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (circle.ifChose(e) && ifCirclePicked) {
            ...
            if (!ifCloseFrame) {
                ...
                if (ifDrawerDownClose) {
                    ...
                    if (!ifCode) {
                        ...
                        if (counterCode >= 4 && accumulated.compareTo(theCode) != 0) {
                            message.setText("It's not the code...I should try again.");
                            counterCode = 0;
                            accumulated = "";
                        }
                    }
                ...
                if (e.getX() >= 460 && e.getX() <= 605 && e.getY() >= 625 && e.getY() <= 665) {
                    if (ifSicssorsChoose) {
                ...
                if (ifCloseHole) {
                    ...
                    if (e.getX() >= 570 && e.getX() <= 875 && e.getY() >= 510 && e.getY() <= 620) {
                        if (!ifCirclePicked) {
